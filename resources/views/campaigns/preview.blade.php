...
@section('content')
  ...
  <section id="slider" class="internal-section">
    <div class="container">
      ...
      <div class="slider-content" data-campaign-preview-wrap>
        <div class="option active">
          <div class="media">
            <input type="hidden" value={{ env('APP_STORAGE') }} data-storage-url>
            <img class="img-responsive" src="{{ env('APP_STORAGE') }}/storage/{{$campaign->path_image}}" width="500" height="260" data-image-path>
          </div>
          <div class="content questions">

            {{-- Render title --}}
            <h3 data-campaign-title>{{ $campaign->title }}</h3>

            {{-- Campaign ID --}}
            <input type="hidden" data-campaign-id value="">
            
            {{-- Render Questions Here --}}
            <p data-campaign-question >{{ $campaign->question }}</p>
            
            <div class="description question">

            <div data-campaign-answers="">
                <div class="radio yellow yes" data-campaign-answers-list="">
                    <label>
                        <input type="radio" name="answer" class="answer" data-value="Eu quero!" data-answer="yes" data-link="" data-campaign-answer-yes="">
                        Eu quero!
                    </label>
                </div>
                <div class="radio no" data-campaign-answers-list="">
                    <label>
                        <input type="radio" name="answer" class="answer" data-value="Não quero." data-answer="no" data-campaign-answer-no="">
                        Não quero.
                    </label>
                </div>
            </div>
